...
{/* title and form = başlık */}
<View className=" flex justify-around w-full h-full  pt-90 pb-80" >
    {/* title = başlık */}
<View className= "flex items-center">
    <Animated.Text  entering={FadeInUp.duration(1000).springify()} className="text-5xl font-bold tracking-wider text-white">SignUp</Animated.Text>
</View>
{/* form  */}
